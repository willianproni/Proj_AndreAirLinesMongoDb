...
namespace AirportDataDapper.Reposity
{
    public class AirportDataReposity : IAirpotyDateReposity
    {
        ...
        public AirportData Get(string iata) //Buscar um Determinado Dado de Aeroporto pelo ID
        {
            ...
            {
                dataBase.Open();
                var airportSeach = dataBase.QueryFirstOrDefault<AirportData>(AirportData.GETIATA, new { code = iata }); //O Var airportSheach vai receber a consulta pelo ID no AirportData.
                                                                                                                      //E retornar a informação se for encontrado .
                return (AirportData)airportSeach; //Retorno do Aeroporto encontrado.
            }
        }
