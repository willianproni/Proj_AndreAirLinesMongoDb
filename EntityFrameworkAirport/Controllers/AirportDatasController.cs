...
namespace EntityFrameworkAirport.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class AirportDatasController : ControllerBase
    {
        private readonly EntityFrameworkAirportContext _context;

        public AirportDatasController(EntityFrameworkAirportContext context)
        {
            _context = context;
        }
